#This was grossly stolen but done some minor tweaks in the export heading sections, nothing major to warrant it being classified as my own work
...
$fileServer = "member1.example.com"
 
$date = get-date
$datefile = get-date -uformat '%m-%d-%Y-%H%M%S'
$filename = "$env:USERPROFILE\Desktop\export_shares.csv"
